...
public class CompanyDaoTestSuite {
    ...
    public void testRetrieveWithLastname(){
        ...
        List<Employee> empList = employeeDao.retrieveWithLastname("Smith2");
    ...
    public void testRetrieveCompaniesWithFirst3Letters(){
        //Given
        Employee johnSmith = new Employee("John", "Smith3");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson3");
        Employee lindaKovalsky = new Employee("Linda", "Kovalsky3");

        Company softwareMachine = new Company("Software Machine3");
        Company dataMaesters = new Company("Data Maesters3");
        Company greyMatter = new Company("Grey Matter3");
        ...
        List<Company> companyList = companyDao.retrieveCompaniesWithFirst3Letters("Dat");
